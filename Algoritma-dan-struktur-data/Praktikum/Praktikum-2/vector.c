...
VECTOR Add(VECTOR a, VECTOR b)
{
    ...
    VECTOR hasil;
    /*ALGORITMA*/
    hasilX = AbsisComponent(a) + AbsisComponent(b);
    hasilY = OrdinatComponent(a) + OrdinatComponent(b);
    CreateVector(&hasil, hasilX, hasilY);
    return hasil;
}
...
VECTOR Multiply(VECTOR v, float s)
{
    ...
    VECTOR hasil;
    /*ALGORITMA*/
    hasilX = AbsisComponent(v) * s;
    hasilY = OrdinatComponent(v) * s;
    CreateVector(&hasil, hasilX, hasilY);
    return hasil;
}